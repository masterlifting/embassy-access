...
let spread (request: Request<Payload>) =
    ...
    | Failed error ->
        ...
        $"The error message is not implemented yet: %s{error.Message}" |> NotImplemented |> Error |> async.Return
    | Completed _ ->
        ...
        | HasAppointments appointments ->
            ...
            // |> Some
            $"Appointment message is not implemented yet: %A{appointments}" |> NotImplemented |> Error |> async.Return
