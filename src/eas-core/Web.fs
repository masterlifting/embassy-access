            ...
            async {
                return
                    Ok(
                        ...
                        <form name="aspnetForm" method="post" action="OrderInfo.aspx?id=20781&amp;cd=f23cb539&amp;ems=143F4DDF" id="aspnetForm" onsubmit="WaitAnswer()">
                        <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUKMTcyNjMyOTQ4Nw9kFgJmD2QWAgIFD2QWAgIBDxYCHghvbnN1Ym1pdAUMV2FpdEFuc3dlcigpFgICAw9kFgQCBg8PFgIeDEVycm9yTWVzc2FnZQUMRXJyb3JNZXNzYWdlZGQCEg8PFgIeCEltYWdlVXJsBRh+L0NvZGVJbWFnZS5hc3B4P2lkPWM2NzJkZGQzEjbUyU3trf55VKTH5ibHzUXPcA==" />

                        <input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="EE4D9765" />
                        <input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEWBwKwt8UWAuaN18YNAouzu58LArnKwuMLAqPwypgIArKtiNkLAtSz564LByxJv7FjPntnZskcTUrOcpLBAu4=" />
                        ...
                        <td id="center-panel">
                         ...
                         <style>#ImgCnt{overflow: hidden;width: 200px;height: 200px; margin: 0 0 20px;}#ImgCnt img{margin: 0px 0px 0px -200px;}</style>
                            ...
                            Введите символы с картинки.
                             ...
                             <div class="inp">    
                                <div id='ImgCnt'> 
                                        <img id="ctl00_MainContent_imgSecNum" src="CodeImage.aspx?id=c672" alt="Необходимо включить загрузку картинок в браузере." border="0" />
                                </div>
                            <input name="ctl00$MainContent$txtCode" type="text" id="ctl00_MainContent_txtCode" onpaste="return false" />
                            </div>
